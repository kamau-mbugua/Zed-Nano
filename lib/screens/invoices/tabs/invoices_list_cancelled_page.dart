...
class InvoicesListCancelledPage extends StatefulWidget {
  const InvoicesListCancelledPage({Key? key}) : super(key: key);

  @override
  _InvoicesListCancelledPageState createState() => _InvoicesListCancelledPageState();
}

class _InvoicesListCancelledPageState extends State<InvoicesListCancelledPage> {

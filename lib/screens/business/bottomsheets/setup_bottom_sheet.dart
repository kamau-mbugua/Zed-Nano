...
class SetupStepBottomSheet extends StatefulWidget {

  SetupStepBottomSheet({required this.currentStep, super.key});
  String currentStep;

  @override
  State<SetupStepBottomSheet> createState() => _SetupStepBottomSheetState();
}

class _SetupStepBottomSheetState extends State<SetupStepBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return Consumer<WorkflowViewModel>(
      builder: (context, viewModel, child) {
        ...
        // Update currentStep based on viewModel state
        widget.currentStep = viewModel.workflowState?.toLowerCase() ?? '';

        //listen to step change and update accordingly

        // Auto-close bottom sheet when workflow is complete
        if (viewModel.workflowState?.toLowerCase() == 'complete') {

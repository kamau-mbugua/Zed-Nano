...
class PendingCustomersListPage extends StatefulWidget {
  const PendingCustomersListPage({Key? key}) : super(key: key);

  @override
  State<PendingCustomersListPage> createState() => _PendingCustomersListPageState();
}

class _PendingCustomersListPageState extends State<PendingCustomersListPage> {
                    ...
                    builderDelegate: PagedChildBuilderDelegate<Customer>(
                      ...
                      noItemsFoundIndicatorBuilder: (context) => const Center(
                        child: CompactGifDisplayWidget(
                          ...
                          subtitle: "No Awaiting Customers in your business, yet! Add to view them here.",
                        ),
                      ),
                    ),
                  ),

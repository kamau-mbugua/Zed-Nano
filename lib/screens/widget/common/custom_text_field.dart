...
class CustomTextField extends StatefulWidget {
  ...
  final bool isDropdown; // New property to enable dropdown
  final List<String>? dropdownItems; // Dropdown options
  final Function(String)? onDropdownChanged; // Callback for dropdown selection
        ...
        decoration: widget.inputDecoration ??
            InputDecoration(
              ...
              border: widget.isShowBorder
                ...
                borderSide:
                const BorderSide(style: BorderStyle.solid, width: 1),
              )
                  : InputBorder.none,

...
class AddUsersDeclinedApprovalPageState extends StatefulWidget {
  const AddUsersDeclinedApprovalPageState({Key? key}) : super(key: key);

  @override
  State<AddUsersDeclinedApprovalPageState> createState() => _AddUsersDeclinedApprovalPageStateState();
}

class _AddUsersDeclinedApprovalPageStateState extends State<AddUsersDeclinedApprovalPageState> {

class GenerateInvoiceResponse {
  ...
  factory GenerateInvoiceResponse.fromJson(Map<String, dynamic> json) {
    return GenerateInvoiceResponse(
      ...
      data: json['data'] != null 
          ? GeneratedInvoiceData.fromJson(json['data'] as Map<String, dynamic>)
          : null,
    );
  }
...
class GeneratedInvoiceData {
  ...
  factory GeneratedInvoiceData.fromJson(Map<String, dynamic> json) {
    return GeneratedInvoiceData(
      ...
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => GeneratedInvoiceItem.fromJson(e as Map<String, dynamic>))
          .toList(),
